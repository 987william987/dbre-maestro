...
const PERMISSION_METADATA: PermissionOption[] = [
  ...
  { key: 'db_connections.overview', module: 'DB Connections', action: 'Overview', label: 'DB Connection Overview', description: 'View connection endpoints, credentials, and test status.' },
  { key: 'db_connections.databases', module: 'DB Connections', action: 'Databases', label: 'DB Connection Databases', description: 'View database size and collation snapshots.' },
  { key: 'db_connections.accounts', module: 'DB Connections', action: 'Accounts', label: 'DB Connection Accounts', description: 'View database-native accounts, roles, and grants.' },
