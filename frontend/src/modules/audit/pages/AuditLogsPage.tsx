...
const ACTION_OPTIONS = [
  ...
  { value: 'setup_admin_create', label: 'Setup Admin Create' },
  { value: 'setup_admin_create_failed', label: 'Setup Admin Create Failed' },
  { value: 'auth_group_security_denied', label: 'Auth Group Security Denied' },
  { value: 'user_security_denied', label: 'User Security Denied' },
  { value: 'auth_group_permission_add', label: 'Add Auth Group Permission' },
  { value: 'auth_group_permission_remove', label: 'Remove Auth Group Permission' },
  { value: 'auth_group_db_connection_add', label: 'Add Auth Group DB Connection' },
  { value: 'auth_group_db_connection_remove', label: 'Remove Auth Group DB Connection' },
  ...
  { value: 'user_permission_remove', label: 'Remove User Permission' },
  { value: 'user_db_connection_add', label: 'Add User DB Connection' },
  { value: 'user_db_connection_remove', label: 'Remove User DB Connection' },
  { value: 'db_connection_test', label: 'Test DB Connection' },
  { value: 'saved_query_create', label: 'Create Saved Query' },
  { value: 'saved_query_delete', label: 'Delete Saved Query' },
...
const RESOURCE_OPTIONS = [
  ...
  { value: 'scheduled_sql_report', label: 'Scheduled SQL Report' },
