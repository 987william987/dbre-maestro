    ...
    <div ref={containerRef} className={cn('relative', className)}>
      <button
        ...
        className={cn(
          ...
          size === 'md'
            ? 'h-10 rounded-lg px-4 text-[12px] font-medium shadow-soft'
      ...
      {open ? (
        ...
        >
          <div role="listbox" aria-label={`${ariaLabel} options`} className="grid gap-1">
            {options.map((option) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'flex items-center justify-between rounded-md px-3 py-2 text-left text-[12px] font-medium transition',
